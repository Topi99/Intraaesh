<%@ Page Language="VB" AutoEventWireup="false" CodeFile="st.aspx.vb" Inherits="st" %>
...
<body>
    ...
    <div class="tit">
        <h1 style="color:#f9e79f">Secretaría Técnica</h1>
    </div>
    
     <div class="panel" >
        
       <ul>
            <li><a class="active" href="~/#">ST</a></li>
    ...
    <div class="content">
        <div class="da_foto">
              <a href="#" class="text-center"><img src="../img/areas_fotos/st.png" alt="da" width="800" /></a> 
                <h2 class="text-center">MIGUEL ÁNGEL LEÓN SALINAS</h2>
                <p class="text-center">SECRETARIO TÉCNICO</p>
         </div>
    </div>
