<%@ Page Language="VB" AutoEventWireup="false" CodeFile="dti.aspx.vb" Inherits="dti" %>
...
<body>
    ...
    <div class="tit">
        <h1 style="color:#f9e79f">Dirección de Tecnología de la Información </h1>
    </div>
    
     <div class="panel" >
        
       <ul>
            <li><a class="active" href="~/#">DTI</a></li>
            <li><a href="da.aspx">Inicio</a></li>            
            <li><a href="~/#">Facultades</a></li>
            <li><a href="~/#">POA</a></li>    
            <li><a href="~/#">Manual de políticas TI</a></li>       
    ...
    <div class="content">
        <div class="da_foto">
              <a href="#" class="text-center"><img src="../img/areas_fotos/dti.png" alt="da" width="800" /></a> 
                <h2 class="text-center">RAÚL ANDRÉS BAÑOS BEZIES</h2>
                <p class="text-center">DIRECTOR DE TECNOLOGÍA DE LA INFORMACIÓN</p>
         </div>
    </div>
