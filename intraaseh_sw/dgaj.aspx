<%@ Page Language="VB" AutoEventWireup="false" CodeFile="dgaj.aspx.vb" Inherits="dgaj" %>
...
<body>
   ...
   <div class="wrapper">
    ...
    <div class="tit">
        <h1 style="color:#f9e79f">Dirección General de Asuntos Jurídicos </h1>
    </div>
    
     <div class="panel" >
        
       <ul>
            <li><a class="active" href="~/#">DGAJ</a></li>
            <li><a href="da.aspx">Inicio</a></li>
            <li><a href="~/#">Facultades</a></li>
            <li><a href="~/#">Sistema de Declaración Patrimonial</a></li>
    ...
    <div class="content">
        <div class="da_foto">
              <a href="#" class="text-center"><img src="../img/areas_fotos/dgaj.png" alt="da" width="800" /></a> 
                <h2 class="text-center">OSCAR HUGO CERVANTES HERRERA</h2>
                <p class="text-center">DIRECTOR GENERAL DE ASUNTOS JURÍDICOS</p>
         </div>
    </div>
