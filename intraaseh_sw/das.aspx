<%@ Page Language="VB" AutoEventWireup="false" CodeFile="das.aspx.vb" Inherits="das" %>
...
<body>
    ...
    <div class="tit">
        <h1 style="color:#f9e79f">Despacho del Auditor Superior</h1>
    </div>
    
     <div class="panel" >
        
       <ul>
            <li><a class="active" href="~/#">DAS</a></li>
            <li><a href="das.aspx">Inicio</a></li>
            <li><a href="Informes.aspx">Informes de Aditoría</a></li>
    ...
    <div class="content">
        <div class="da_foto">
              <a href="#"><img src="../img/areas_fotos/das.png" alt="das" width="800" ></a> 
