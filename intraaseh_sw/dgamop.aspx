<%@ Page Language="VB" AutoEventWireup="false" CodeFile="dgamop.aspx.vb" Inherits="dgamop" %>
...
<body>
   ...
   <div class="wrapper">
    ...
    <div class="tit">
        <h1 style="color:#f9e79f">Dirección General de Auditoría a Municipios y Obra Pública </h1>
    </div>
    
     <div class="panel" >
        
       <ul>
            <li><a class="active" href="~/#">DGAMOP</a></li>
            <li><a href="da.aspx">Inicio</a></li>
            <li><a href="~/#">Facultades Generales</a></li>
            <li><a href="~/#">Facultades Especifícas</a></li>
            <li><a href="~/#">Programa Anual de Auditorías, Visitas, Revisiones e Inspecciones "PAAVRI" Municipios</a></li>
            <li><a href="~/#">Programa Anual de Auditorías, Visitas, Revisiones e Inspecciones "PAAVRI" Organismos Descentralizados Municipales</a></li>
            <li><a href="~/#">POA</a></li>           
    ...
    <div class="content">
        <div class="da_foto">
              <a href="#" class="text-center"><img src="../img/areas_fotos/dgamop.png" alt="dgamop" width="800" /></a> 
                <h2 class="text-center">ENRIQUE ENCISO ARELLANO</h2>
                <p class="text-center">DIRECTOR GENERAL DE AUDITORÍA A MUNICIPIOS Y OBRA PÚBLICA</p>
         </div>
    </div>
