<%@ Page Language="VB" AutoEventWireup="false" CodeFile="organigrama.aspx.vb" Inherits="organigrama" %>
...
<body>
    ...
    <div class="wrapper">
         ...
         <div class="tit">
        <h1 style="color:#f9e79f">Organigrama</h1>
    </div>
     ...
     <div class="panel" >
       ...
       <ul>
            ...
            <li><a href="~/#">Decálogo del servidor público </a></li>
    ...
    <div class="content">
        <div class="decalogo">
              <a href="#"><img src="../img/bits/organigrama.jpg" alt="da" width="800" /></a> 
