<%@ Page Language="VB" AutoEventWireup="false" CodeFile="dgae.aspx.vb" Inherits="dgae" %>
...
<body>
    ...
    <div class="tit">
        <h1 style="color:#f9e79f">Dirección General de Auditoría Estatal</h1>
    </div>
    
     <div class="panel" >
        
       <ul>
            <li><a class="active" href="~/#">DGAE</a></li>
            <li><a href="dgae.aspx">Inicio</a></li>
            <li><a href="~/#">Facultades generales</a></li>
            <li><a href="~/#">Facultades especifícas</a></li>
            <li><a href="~/#">Programa Anual de Aditorías, Visitas, Revisiones e Inspecciones "PAAVRI"</a></li>           
            <li><a href="~/#">POA</a></li>
    ...
    <div class="content">
        <div class="da_foto">
              <a href="#"><img src="../img/areas_fotos/dgae.png" alt="dgae" width="800" ></a> 
