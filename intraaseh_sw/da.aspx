<%@ Page Language="VB" AutoEventWireup="false" CodeFile="da.aspx.vb" Inherits="da" %>
...
<body>
    ...
    <div class="tit">
        <h1 style="color:#f9e79f">Dirección de Administración</h1>
    </div>
    
     <div class="panel" >
        
       <ul>
            <li><a class="active" href="~/#">DA</a></li>
            <li><a href="da.aspx">Inicio</a></li>
            <li><a href="~/#">Lineamientos Administrativos</a></li>
    ...
    <div class="content">
        <div class="da_foto">
              <a href="#" class="text-center"><img src="../img/areas_fotos/da.png" alt="da" width="800" /></a> 
                <h2 class="text-center">MARÍA DE LOURDES GARCÍA SPÍNOLA</h2>
                <p class="text-center">DIRECTORA DE ADMINISTRACIÓN</p>
         </div>
