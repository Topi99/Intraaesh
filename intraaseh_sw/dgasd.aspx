<%@ Page Language="VB" AutoEventWireup="false" CodeFile="dgasd.aspx.vb" Inherits="dgasd" %>
...
<body>
   ...
   <div class="wrapper">
    ...
    <div class="tit">
        <h1 style="color:#f9e79f">Dirección General de Auditoría Sobre el Desempeño </h1>
    </div>
    
     <div class="panel" >
        
       <ul>
            <li><a class="active" href="~/#">DGASD</a></li>
    ...
    <div class="content">
        <div class="da_foto">
              <a href="#" class="text-center"><img src="../img/areas_fotos/dgasd.png" alt="da" width="800" /></a> 
                <h2 class="text-center">PERLA YAZMÍN CASTRO CONTRERAS</h2>
                <p class="text-center">DIRECTORA GENERAL</p>
         </div>
    </div>
