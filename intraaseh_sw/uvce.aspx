<%@ Page Language="VB" AutoEventWireup="false" CodeFile="uvce.aspx.vb" Inherits="uvce" %>
...
<body>
    ...
    <div class="tit">
        <h1 style="color:#f9e79f">Unidad de Vigilancia, Control y Evaluación</h1>
    </div>
    
     <div class="panel" >
        
       <ul>
            <li><a class="active" href="~/#">UVCE</a></li>
    ...
    <div class="content">
        <div class="da_foto">
              <a href="#" class="text-center"><img src="../img/areas_fotos/uvce.png" alt="da" width="800" /></a> 
                <h2 class="text-center">ENNA KARELL BARRERA ALARCÓN</h2>
                <p class="text-center">TITULAR DE LA UNIDAD DE VIGILANCIA, CONTROL Y EVALUACIÓN</p>
         </div>
    </div>
