<%@ Page Language="VB" AutoEventWireup="false" CodeFile="dmcp.aspx.vb" Inherits="dmcp" %>
...
<body>
    ...
    <div class="tit">
        <h1 style="color:#f9e79f">Dirección de Mejora Continua y Profesionalización </h1>
    </div>
    
     <div class="panel" >
        
       <ul>
            <li><a class="active" href="~/#">DMCP</a></li>
    ...
    <div class="content">
        <div class="da_foto">
              <a href="#" class="text-center"><img src="../img/areas_fotos/dmcp.png" alt="da" width="800" /></a> 
                <h2 class="text-center">VICTORIA RUBÍ ALBURQUERQUE LÓPEZ</h2>
                <p class="text-center">DIRECTORA DE MEJORA CONTINUA Y PROFESIONALIZACIÓN</p>
         </div>
    </div>
