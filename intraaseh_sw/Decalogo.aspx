<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Decalogo.aspx.vb" Inherits="Decalogo" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Decálogo del servidor público </title>
...
<body>
                                    ...
                                    <nav class="panelItem">
                                        <dx:ASPxMenu ID="NavMenu" runat="server" ClientInstanceName="NavMenu" EnableAnimation="true" CssClass="navMenu">
                                            ...
                                            <Items>
                                                ...
                                                <dx:MenuItem Text="DECLARACIÓN PATRIMONIAL" NavigateUrl="~/#" />
    ...
    <div class="tit">
        <h1 style="color:#f9e79f">Decálogo del servidor público</h1>
    </div>
    
     <div class="panel" >
        
       <ul>
            <li><a class="active" href="~/#">Identidad</a></li>
            <li><a href="~/#">Código de ética</a></li>
            <li><a href="Decalogo.aspx">Decálogo del servidor público</a></li>
            <li><a href="organigrama.aspx">Organigrama</a></li>
            <li><a href="~/#">Identidad visual o grafica DOF</a></li>
       </ul>
     </div>

    <div class="content">
        <div class="decalogo">
              <a href="#"><img src="../img/bits/decalogo.jpg" alt="da" width="800" /></a> 
